...
fun getCodeForToolbarKey(key: ToolbarKey) = Settings.getInstance().getCustomToolbarKeyCode(key) ?: when (key) {
    ...
    TIMESTAMP_INSERT -> KeyCode.TIMESTAMP_INSERT
}
...
enum class ToolbarKey {
    ...
    PAGE_UP, PAGE_DOWN, FULL_LEFT, FULL_RIGHT, PAGE_START, PAGE_END, TIMESTAMP_TOGGLE, TIMESTAMP_INSERT
}
...
val defaultToolbarPref by lazy {
    val default = listOf(SETTINGS, VOICE, CLIPBOARD, UNDO, REDO, SELECT_WORD, COPY, PASTE, LEFT, RIGHT, TIMESTAMP_INSERT)
