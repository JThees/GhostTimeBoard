...
object KeyCode {
    ...
    const val TIMESTAMP_TOGGLE =         -10052
    const val TIMESTAMP_INSERT =         -10053
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        SEND_INTENT_THREE, INLINE_EMOJI_SEARCH_DONE, META_LOCK, TIMESTAMP_TOGGLE, TIMESTAMP_INSERT
        -> this
